...
#add CheckBox widget to GUI
accept = CheckBox(app, text = "Click to accept to terms and conditions", grid = [1,1], align ='left')

print("\n")
#add ButtonGroup widget to GUI
pick_choice = ButtonGroup(app, options=[["First", "1"], ["Second", "2"], ["Third", "1"]], 
